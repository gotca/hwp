<footer>
    ...
    <section class="footer-section sub text-align--center">
        <p>Special thanks to Mrs. Worst for taking great pictures &amp; <a href="{{route('players', ['nameKey' => 'EzraDejonge'])}}" title="Ezra Dejonge">Ezra Dejonge</a> for making the sweet 3d polo ball!</p>
    </section>
