...
},{"./schedule/filterable":87,"./schedule/subscribe-modal":94,"./schedule/today-row":95}],95:[function(require,module,exports){
'use strict';
...
},{"lodash":28}],94:[function(require,module,exports){
'use strict';
...
},{"vex-js":64}],87:[function(require,module,exports){
'use strict';

var _tableFilter = require('./filters/table-filter');
...
var _selectFilter = require('./filters/select-filter');

var _selectFilter2 = _interopRequireDefault(_selectFilter);

var _checkboxFilter = require('./filters/checkbox-filter');

var _checkboxFilter2 = _interopRequireDefault(_checkboxFilter);

var _radioFilter = require('./filters/radio-filter');

var _radioFilter2 = _interopRequireDefault(_radioFilter);

var _dateFilter = require('./filters/date-filter');
...
function init() {
	window.addEventListener('DOMContentLoaded', function () {
		...
		var tableFilter = new _tableFilter2.default(table);

		tableFilter.add(0, new _checkboxFilter2.default([{ value: 'tournament', label: 'Tournament' }, { value: 'tournament-game', label: 'Tournament Game' }, { value: 'game', label: 'Game' }]));
		tableFilter.add(1, new _dateFilter2.default());
		tableFilter.add(2, new _radioFilter2.default([{ value: 'V', label: 'Varsity' }, { value: 'JV', label: 'JV' }]));
		tableFilter.add(3, new _filter2.default());
		tableFilter.add(4, new _filter2.default());
		tableFilter.add(5, new _checkboxFilter2.default([{ value: 'win', label: 'Win' }, { value: 'loss', label: 'Loss' }, { value: 'tie', label: 'Tied' }]));
	});
}

module.exports = init;

},{"./filters/checkbox-filter":88,"./filters/date-filter":89,"./filters/filter":90,"./filters/radio-filter":91,"./filters/select-filter":92,"./filters/table-filter":93}],93:[function(require,module,exports){
'use strict';
...
var TableFilter = function () {
	function TableFilter(table) {
		...
		$(document).on('click', function (event) {
			var toClose = _this.filters.slice();

			if ($(event.target).closest('.filter').length) {
				var exclude = $(event.target).closest('.filter').data('filterIndex');
				var removeIdx = toClose.findIndex(function (filter) {
					return filter.index === exclude;
				});

				toClose.splice(removeIdx, 1);
			}

			toClose.forEach(function (filter) {
				return filter.hide();
			});
		});
	}
	...
	_createClass(TableFilter, [{
		...
		value: function update() {
			var enabled = this.filters.filter(function (f) {
				return f.enabled;
			});
			var filtered = this.rows;

			if (enabled.length) {
				enabled.forEach(function (filter) {
					filter.prepare();
				});
			...
			this.tbody.innerHTML = filtered.map(function (e) {
				return e.outerHTML;
			}).join('');
		}
	}]);
...
},{"jquery":27,"lodash":28}],92:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
	value: true
});
exports.SelectFilter = undefined;
...
var SelectFilter = function (_Filter) {
	_inherits(SelectFilter, _Filter);

	function SelectFilter(options) {
		_classCallCheck(this, SelectFilter);

		var _this = _possibleConstructorReturn(this, (SelectFilter.__proto__ || Object.getPrototypeOf(SelectFilter)).call(this, true));
	...
	_createClass(SelectFilter, [{
		...
		value: function getPanelContent() {
			...
			opts += this.options.map(function (o) {
		...
		value: function initPanel(panel) {
			...
			var input = panel.querySelector('select');
		...
		value: function filter(cell) {
			var val = _filter.Filter.getCellValue(cell);
...
},{"./filter":90}],91:[function(require,module,exports){
"use strict";
...
var _checkboxFilter = require("./checkbox-filter");
...
var RadioFilter = function (_CheckboxFilter) {
	_inherits(RadioFilter, _CheckboxFilter);

	function RadioFilter() {
		_classCallCheck(this, RadioFilter);

		return _possibleConstructorReturn(this, (RadioFilter.__proto__ || Object.getPrototypeOf(RadioFilter)).apply(this, arguments));
	}
	...
	return RadioFilter;
}(_checkboxFilter.CheckboxFilter);

exports.RadioFilter = RadioFilter;
exports.default = RadioFilter;

},{"./checkbox-filter":88}],89:[function(require,module,exports){
'use strict';
...
var DateFilter = function (_Filter) {
	_inherits(DateFilter, _Filter);

	function DateFilter(options) {
		_classCallCheck(this, DateFilter);

		var _this = _possibleConstructorReturn(this, (DateFilter.__proto__ || Object.getPrototypeOf(DateFilter)).call(this, true));
	...
	_createClass(DateFilter, [{
		...
		value: function prepare() {
			...
			this.endTime = new Date(this.endTime.getFullYear(), this.endTime.getMonth(), this.endTime.getDate(), 23, 59, 59).getTime() / 1000 | 0;
		}
...
},{"./filter":90,"flatpickr":12}],88:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
	value: true
});
exports.CheckboxFilter = undefined;
...
var CheckboxFilter = function (_Filter) {
	...
	function CheckboxFilter(options) {
		...
		var _this = _possibleConstructorReturn(this, (CheckboxFilter.__proto__ || Object.getPrototypeOf(CheckboxFilter)).call(this, true));
	...
	_createClass(CheckboxFilter, [{
		...
		value: function getPanelContent() {
			...
			var name = CheckboxFilter.getInputName();
		...
		key: 'clear',
		value: function clear() {
			this.panelEl.querySelectorAll('input:checked').forEach(function (e) {
		...
		key: 'prepare',
		value: function prepare() {
			var checked = this.panelEl.querySelectorAll('input:checked');
			checked = [].slice.call(checked);
			checked = checked.map(function (e) {
				return e.value;
			});
...
},{"./filter":90}],90:[function(require,module,exports){
'use strict';
...
var Filter = function () {
	_createClass(Filter, [{
		...
		key: 'filter',
		value: function filter(cell) {
			var val = Filter.getCellValue(cell);

			return val.match(this.regex);
		}
	}]);

	function Filter(skipSetup) {
	...
	_createClass(Filter, [{
		...
		value: function setup() {
			...
			this.holderEl.className = [classes.filter.base, classes.filter.disabled].join(' ');
		...
		key: 'attach',
		value: function attach(index, el, updater) {
			this.index = index;
		...
		value: function createTrigger() {
			...
			trigger.className = ['btn', 'btn--small', classes.button.base].join(' ');
		...
		value: function createPanel() {
			...
			var content = this.getPanelContent();
		...
		key: 'initClear',
		value: function initClear(panel) {
			var btn = panel.querySelector('button.' + classes.clear);
			btn.addEventListener('click', this.clear.bind(this));
		}
	}], [{
		key: 'getCellValue',
		value: function getCellValue(cell) {
			return 'filterValue' in cell.dataset ? cell.dataset.filterValue : cell.textContent.trim();
		}
	}]);
